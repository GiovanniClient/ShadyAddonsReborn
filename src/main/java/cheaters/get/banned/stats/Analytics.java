...
public class Analytics {
    ...
    private static final String sorryJerome = "Sorry Jerome but rat scanners pick these methods up and flag the mod as rat" +
            "Since i want users to feel safe i am removing this code. If there's any way to keep this stuff up without messing with SIDs lmk";
    /*
